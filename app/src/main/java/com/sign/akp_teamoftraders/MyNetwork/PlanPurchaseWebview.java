...
import com.sign.akp_teamoftraders.MyAccount.MyWebViewClient;
...
public class PlanPurchaseWebview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan_purchase_webview);
        sharedPreferences = getSharedPreferences("login_preference",MODE_PRIVATE);
        UserId = sharedPreferences.getString("U_id", "");
        member_id_tv=findViewById(R.id.member_id_tv);
        member_id_tv.setText(UserId);
...
//        Toast.makeText(getApplicationContext(),UserId,Toast.LENGTH_LONG).show();
        ...
        if (wifi.isConnected())
        {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl(" http://api.teamoftraders.in/Customer/_AccountActivationMobile?CustomerCode="+UserId);
        }
