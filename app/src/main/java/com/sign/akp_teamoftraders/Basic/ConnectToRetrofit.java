...
public class ConnectToRetrofit {
    ...
    public ConnectToRetrofit(RetrofitCallBackListenar callbacklistner, Activity context,Call<String> _call, String action, boolean showDialogue) {
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    Log.d("DEBUG", "onResponse : " + response.raw() + "Run time=" + (System.currentTimeMillis() - beginTime));
