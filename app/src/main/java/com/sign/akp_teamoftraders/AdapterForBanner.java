...
//        }
        ...
        Log.d("sddfsdf",bannerData.get(position).getBanner());

        Glide.with(context).asBitmap().load(bannerData.get(position).getBanner()).error(R.drawable.banner).into(new BitmapImageViewTarget(myImage) {
            @Override
